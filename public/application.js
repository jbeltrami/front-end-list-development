...
/***/ (function(module, exports, __webpack_require__) {
	...
	var htmlEvents = __webpack_require__(33);

	$(function () {
	  authEvents.addHandlers();
	  htmlEvents.addHandlers();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateWish = function onCreateWish(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.createWish(data).then(ui.createWishSuccess).catch(ui.createWishFailure);
	};

	var onGetWishes = function onGetWishes(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getWishes(data).then(ui.getWishesSuccess).catch(ui.getWishesFailure);
	};

	var onGetWish = function onGetWish(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getWish(data.wishes.id).then(ui.getWishSuccess).catch(ui.getWishFailure);
	};

	var onUpdateWish = function onUpdateWish(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.updateWish(data.wishes.id, data).then(ui.updateWishSuccess).catch(ui.updateWishFailure);
	};

	var onDeleteWish = function onDeleteWish(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.deleteWish(data.wishes.id).then(ui.deleteWishSuccess).catch(ui.deleteWishFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createWish = function createWish(data) {
	  return $.ajax({
	...
	var getWishes = function getWishes(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/wishes',
	    method: 'GET',
	    headers: {
	...
	var updateWish = function updateWish(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/wishes/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getWishesTable = __webpack_require__(12);
	var getSingleWish = __webpack_require__(32);
	...
	var createWishSuccess = function createWishSuccess(data) {
	  $('#wishes-content').empty();
	  $('#wishes-content').text('You just create a new wish!');
	  resetFields();
	};
	var createWishFailure = function createWishFailure(data) {
	  $('#wishes-content').text('Oops! something went wrong! Could you try again?');
	  resetFields();
	};

	var getWishesSuccess = function getWishesSuccess(data) {
	  resetFields();
	  $('#wishes-content').empty();
	  var indexWishes = getWishesTable({
	    wishes: data.wishes
	  });
	...
	var getWishesFailure = function getWishesFailure(data) {
	  resetFields();
	  $('#wishes-content').text('Oops! something went wrong! Make sure you\'re connected to the internet ');
	};

	var getWishSuccess = function getWishSuccess(data) {
	  resetFields();
	  $('#wishes-content').empty();
	  $('.read-one-wish').css('display', 'none');
	  var indexWishes = getSingleWish({
	    wish: data.wish
	  });
	  $('#wishes-content').append(indexWishes);
	  $('.destroy-wish').on('click', function () {
	...
	var getWishFailure = function getWishFailure(data) {
	  resetFields();
	  $('#wishes-content').text("Try another number! Make sure to hit 'See your wishes' first");
	};

	var updateWishSuccess = function updateWishSuccess(data) {
	  resetFields();
	  $('#wishes-content').empty();
	  $('.change-wish-screen').hide();
	  $('#wishes-content').text('You just updated your wish!');
	};
	var updateWishFailure = function updateWishFailure(data) {
	  resetFields();
	  $('#wishes-content').text('Make sure you have the correct wish number to update.');
	};

	var deleteWishSuccess = function deleteWishSuccess(data) {
	  resetFields();
	  $('#wishes-content').text('Wish deleted');
	};
	var deleteWishFailure = function deleteWishFailure(data) {
	  resetFields();
	...
	module.exports = {
	  ...
	  createWishSuccess: createWishSuccess,
	  createWishFailure: createWishFailure,
	  getWishesSuccess: getWishesSuccess,
	  getWishesFailure: getWishesFailure,
	  getWishSuccess: getWishSuccess,
	  getWishFailure: getWishFailure,
	  updateWishSuccess: updateWishSuccess,
	  updateWishFailure: updateWishFailure,
	  deleteWishSuccess: deleteWishSuccess,
	  deleteWishFailure: deleteWishFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td>"
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.goal : stack1), depth0))
	    + "</td>\n      <td>\n        <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger destroy-wish\">Delete Wish</button>\n      </td>\n      <td>\n        <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-warning update-wish\">Update Wish</button>\n      </td>\n    </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return " <table id=\"wishes-table\" class=\"table\">\n   <thead>\n     <tr>\n       <th>Wish Number</th>\n       <th>Wish</th>\n       <th>Delete</th>\n       <th>Update</th>\n     </tr>\n  </thead>\n\n  <tbody id=\"wishes-table-body\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.wishes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n\n </table>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<table id=\"wish-table\" class=\"table\">\n  <thead>\n    <tr>\n      <th>Wish Number</th>\n      <th>Wish</th>\n      <th>Delete</th>\n      <th>Update</th>\n    </tr>\n </thead>\n\n <tbody id=\"wish-table-body\">\n   <tr>\n     <td>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.wish : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</td>\n     <td>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.wish : depth0)) != null ? stack1.goal : stack1), depth0))
	    + "</td>\n     <td>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.wish : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger destroy-wish\">Delete Wish</button>\n     </td>\n     <td>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.wish : depth0)) != null ? stack1.id : stack1), depth0))
